                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-quantity">
                                            <div class="quantity buttons_added">
                                                ...
                                                <input type="number" size="4" class="input-text qty text" title="Qty" value="<?php echo htmlspecialchars( $value1["nrqtd"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" 
												min="0" step="1">
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            <tr class="cart-subtotal">
                                                <th>Subtotal</th>
                                                <td><span class="amount">R$ <?php echo formatPrice(valorProduto($products)); ?></span></td>
												<!--<td><span class="amount">R$ </span></td>-->
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                <th>Total</th>
                                                <td><strong><span class="amount">R$ <?php echo formatPrice(valorProduto($products)+$cart["vlfreight"]); ?></span></strong> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
